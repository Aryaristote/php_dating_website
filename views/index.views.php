    ...
    <div class="steps-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="steps-section-inner wow fadeInUp">
                        <div class="myCol1">
                            <h4 class="title">
                                3 EASY STEPS
                            </h4>
                        ...
                        <div class="myCol3">
                            <a href="login.html" class="custom-button">Join Now!</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="flirting-section home2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="content">
                        <div class="section-header">
                            ...
                            <p>
                                ...
                                integral part of our lives. They allow you to check the profile of singles living near you, to chat with them, to meet them and maybe to fall in love.
                            </p>
                            <br>
                            <p>
                                If you’re searching for a simple dating app with free features allowing to meet singles, you’re in good hands with Pairko. With Pairko you get all you need from a mobile dating app, which presents you thousands of users through your smartphone in a very pleasant experience. 
                            </p>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-community-box wow fadeInUp" data-wow-delay="0.1s">
                        <div class="img">
                        ...
                        <div class="box-footer">
                            ...
                            <div class="right">
                                <i class="fas fa-users"></i> 100
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-community-box wow fadeInUp" data-wow-delay="0.2s">
                        <div class="img">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-community-box wow fadeInUp" data-wow-delay="0.3s">
                        <div class="img">
    ...
    <section class="home2-statistics-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stat-item wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div class="stat-content">
                                ...
                                <span class="info">Messages sent per day</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="stat-item wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <h3 class="counter-item"><span class=" odometer" data-odometer-final="447"></span>M</h3>
                                <span class="info">Registered users worldwide</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="stat-item wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="stat-content">
                                ...
                                <span class="info">Monthly active users</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="stat-item wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="stat-content">
                                <h3 class="counter-item"><span class=" odometer" data-odometer-final="300"></span>K</h3>
                                <span class="info">New daily sign ups</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="home2-sucess-stories-section">
                ...
                <div class="col-lg-5 align-self-center">
                    <div class="content">
                        <div class="section-header">
                            ...
                            <p>
                                Choose from one of our membership levels 
                                and unlock features you need.Benefit from 
                                Peyamba at its maximum capacity by choosing
                                the plan that suits you!
                            </p>
                        </div>
                        
                        <a href="#" class="custom-button">Membership details</a>
                    </div>
                </div>
...
<!-- Mirrored from pixner.net/peyamba/peyamba/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Feb 2022 19:08:57 GMT -->
</html>